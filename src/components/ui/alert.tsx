  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        rum: 
          "border-rum-500/50 bg-rum-500/10 text-rum-700 dark:text-rum-400 [&>svg]:text-rum-500",
        teal:
          "border-teal-500/50 bg-teal-500/10 text-teal-700 dark:text-teal-400 [&>svg]:text-teal-500",
        success:
